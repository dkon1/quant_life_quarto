...
![Human blood circulates throughout the body and returns to the heart, veins shown in blue and arteries in red. *Circulatory System en* by LadyofHats in public domain via Wikimedia Commons.](ch1/Circulatory_System_no_tags_cropped.png){width=4in #fig-blood-circ}
...
![Illustration of Galen's conception of the blood system, showing different spirits traveling in one direction, but not circulating. Reproduced by permission of [Barbara Becker](https://faculty.humanities.uci.edu/bjbecker/).](ch1/galenheartc.png){width=4in #fig-galen}
