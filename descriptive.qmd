...
![Different types of substitution \index{mutation!substitution} point mutations are distinguished by their effects on the gene products; image by Jonsta247 in public domain via Wikimedia Commons.](ch3/Point_mutations-en.png){width=5in #fig-ch3-mutation}
...
```{r}
#| fig-cap: "Length of bacteria Bacillus subtilis measured under the microscope as discrete values with step of 0.5; data from @watkins-intro-stats"
