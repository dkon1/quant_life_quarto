...
```{r ch2-plot1, echo=TRUE}
#| label: ch2-plot1
#| fig-cap: "Two examples of plots using curve()"
#| fig-subcap: 
#|   - "Quadratic $y=x^2$"
...
```{r ch2-plot2, echo=TRUE}
#| label: fig-ch2-plot2
#| fig-cap: "Overlaying multiple plots in R"
#| fig-subcap: 
#|   - "Two exponential functions of the form $y=b+ae^{rx}$" 
#|   - "Two logistic functions of the form $y= ae^{rx}/(b+e^{rx})$"
#| layout-ncol: 2
