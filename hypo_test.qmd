...
The F-statistic is calculate as a ratio of the variance of the means $\mu_i$ of the categories (VM) and the variance of the errors (residuals) $\epsilon_{ij}$ within the categories (VR):
$$ 
F = \frac{VM}{VR}
$$
:::
