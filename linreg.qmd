...
#| label: linreg-HRTemp
#| echo: false
#| fig-cap: 'Linear regression for a data set of heart rates and body temperatures'
#| fig-subcap: 
#|   - "Heart rates (response variable) vs temperature (explanatory variable)" 
#|   - "Residuals of linear regression vs temperature (explanatory variable)" 
#| layout-ncol: 2
